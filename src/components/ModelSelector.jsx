...
const models = [
    { id: 'nano-banana', name: 'Nano Banana', desc: 'Gemini Image Model (Natural Language)' },
    { id: 'jimeng', name: 'Jimeng AI', desc: 'SeaDream 4.0 (Chinese, <800 chars)' },
    { id: 'midjourney', name: 'Midjourney', desc: 'Artistic & Photorealistic (Params)' },
];
        ...
        <div className="model-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
            {models.map((model) => (
                <div
                    ...
                    className={`glass-panel model-card ${selectedModel === model.id ? 'selected' : ''}`}
                    style={{
                        padding: '1.5rem',
                        cursor: 'pointer',
